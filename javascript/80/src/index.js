...
import $ from 'jquery';
import blueCarImg from './images/blueCar2.png';
import greenCarImg from './images/greenCar.png';
import redCarImg from './images/redCar.png';
import orangeCarImg from './images/orangeCar.png';
import grayTruckImg from './images/grayTruck.png';
import orangeTruckImg from './images/orangeTruck.png';
import yellowTruckImg from './images/yellowTruck.png';
import lightGreenCarImg from './images/lightGreenCar.png';
import roadImg from './images/road.png';
import intermediate1 from './images/intermediate1.jpg';
...
cardSelector.append(`<img src=${intermediate1} alt="Blue Car">`);

const blueCar = $(`<img src=${blueCarImg} class="cars" width="${SQUARE_SIZE * 2}" height="${SQUARE_SIZE}" alt="Blue Car">`);
const greenCar = $(`<img src=${greenCarImg} class="cars" width="${SQUARE_SIZE * 2}" height="${SQUARE_SIZE}" alt="Green Car">`);
const redCar = $(`<img src=${redCarImg} class="cars" width="${SQUARE_SIZE * 2}" height="${SQUARE_SIZE}" alt="Red Car">`);
const orangeCar = $(`<img src=${orangeCarImg} class="cars" width="${SQUARE_SIZE * 2}" height="${SQUARE_SIZE}" alt="Orange Car">`);
const grayTruck = $(`<img src=${grayTruckImg} class="cars" width="${SQUARE_SIZE}" height="${SQUARE_SIZE * 3}" alt="Gray Truck">`);
const orangeTruck = $(`<img src=${orangeTruckImg} class="cars" width="${SQUARE_SIZE}" height="${SQUARE_SIZE * 3}" alt="Orange Truck">`);
const yellowTruck = $(`<img src=${yellowTruckImg} class="cars" width="${SQUARE_SIZE}" height="${SQUARE_SIZE * 3}" alt="Yellow Truck">`);
const lightGreenCar = $(`<img src=${lightGreenCarImg} class="cars" width="${SQUARE_SIZE}" height="${SQUARE_SIZE * 2}" alt="Light Green Car">`);
const road = $(`<img src=${roadImg} class="cars" id="road" width="${SQUARE_SIZE * 2}" height="${SQUARE_SIZE}" alt="road">`);
